...
create table users (id bigint primary key auto_increment, code varchar(50) NOT NULL UNIQUE,createdAt datetime,deletedAt datetime, username varchar(20) NOT NULL, passwrd varchar(20) NOT NULL);
