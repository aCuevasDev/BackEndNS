...
//Los JSON Web Tokens están formados por encabezado , contenido y una firma.
function jwtGetCodeJSON($contenido){ //GENERA UN TOKEN CON EL JSON RECIBIDO POR PARAMETRO
...
function jwtCheckCodeJSON($jwt_token){// PARA VERIFICAR UN TOKEN
    $secret_key = 'clave secreta';
