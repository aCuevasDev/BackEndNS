...
/**
 * Base class that represents a row from the 'hint' table.
 *
 *
 *
 * @package    propel.generator.API.Model.Base
 */
abstract class Hint implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Model\\Map\\HintTableMap';
    ...
    /**
     * Initializes internal state of API\Model\Base\Hint object.
     */
    ...
    /**
     * Compares this with another <code>Hint</code> instance.  If
     * <code>obj</code> is an instance of <code>Hint</code>, delegates to
     * <code>equals(Hint)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Hint The current object, for fluid interface
     */
    ...
    public function setHint($v)
    {
        ...
        if ($this->hint !== $v) {
            $this->hint = $v;
            $this->modifiedColumns[HintTableMap::COL_HINT] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildHintQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildHintQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                HintTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = HintTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Hint'][$this->hashCode()])) {
            return '*RECURSION*';
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Model\Hint The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Model\Hint (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Model\Hint Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(HintTableMap::DEFAULT_STRING_FORMAT);
    }
