...
abstract class Room implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Model\\Map\\RoomTableMap';
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[RoomTableMap::COL_NAME] = true;
        }
    ...
    public function setPremium($v)
    {
        ...
        if ($this->premium !== $v) {
            $this->premium = $v;
            $this->modifiedColumns[RoomTableMap::COL_PREMIUM] = true;
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Model\Room The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Model\Room (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Model\Room Clone of current object.
     * @throws PropelException
     */
    ...
    public function initGames($overrideExisting = true)
    {
        ...
        $this->collGames->setModel('\API\Model\Game');
    }
    ...
    public function initItems($overrideExisting = true)
    {
        ...
        $this->collItems->setModel('\API\Model\Item');
    }
