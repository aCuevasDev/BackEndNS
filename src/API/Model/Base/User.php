...
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\API\\Model\\Map\\UserTableMap';
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\API\Model\User The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \API\Model\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \API\Model\User Clone of current object.
     * @throws PropelException
     */
