...
class RoomTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Model.Map.RoomTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Model\\Room';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Model.Room';
     ...
     */
    const COL_PREMIUM = 'room.premium';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Model\\Room');
  ...
  array (
    ...
    1 => ':code',
        ...
        $this->addRelation('Item', '\\API\\Model\\Item', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':room_code',
    1 => ':code',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Model\Room) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(RoomTableMap::DATABASE_NAME);
            $criteria->add(RoomTableMap::COL_CODE, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(RoomTableMap::COL_CODE) && $criteria->keyContainsValue(RoomTableMap::COL_CODE) ) {
